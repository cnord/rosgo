...
func msgPartialTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "msg.partial.tmpl", size: 2315, mode: os.FileMode(436), modTime: time.Unix(1511263052, 0)}
